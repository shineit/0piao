...
class PersonController {
    ...
    public String getFirstNamesHtml() {
        ...
        out.html {
            head {
                title "List of First Names 中文"
            }
            body {
                h1 "List of First Names 中文"
        ...
        println(new String(writer.toString().getBytes("UTF-8"),"utf-8"))
        new String(writer.toString().getBytes("UTF-8"),"utf-8")
